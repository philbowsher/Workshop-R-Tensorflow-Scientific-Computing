# ============================================================================
# Deploy Vetiver API to Posit Connect (Torch Version)
# ============================================================================
...
cat("=======================================================================\n")
cat("DEPLOYING VETIVER API (TORCH) TO POSIT CONNECT\n")
cat("=======================================================================\n\n")
...
model_name <- paste0(connect_user$username, "/peptide_torch_vetiver_", workshop_id)
...
vetiver_deploy_rsconnect(
  ...
  appTitle = paste0("Peptide API (Torch + Vetiver) - ", workshop_id)
)
...
cat("\n=======================================================================\n")
cat("✓ Vetiver API (Torch) deployed!\n")
...
cat("  • Handles torch model loading and predictions\n")
cat("\nNext steps:\n")
cat("  1. Go to Connect UI and find 'Peptide Prediction API (Torch + Vetiver)'\n")
cat("  2. Note the API URL (e.g., /content/xyz-789/)\n")
cat("  3. Run 4_consume_api.R to test the API\n")
cat("=======================================================================\n")
