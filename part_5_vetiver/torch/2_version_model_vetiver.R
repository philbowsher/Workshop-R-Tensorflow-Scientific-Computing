...
cat("=======================================================================\n")
cat("VERSIONING TORCH MODEL WITH VETIVER\n")
cat("=======================================================================\n\n")
...
v <- vetiver_model(
  ...
  description = paste0("Peptide-MHC binding prediction model (Torch + Vetiver) - ", workshop_id),
  metadata = list(
    framework = "torch",
    classes = c("NB", "WB", "SB"),
    input_features = 180,
...
cat("\n=======================================================================\n")
cat("✓ Torch model versioned with Vetiver!\n")
cat("\nWhat Vetiver did for you:\n")
cat("  • Created model card with metadata\n")
cat("  • Handled torch serialization automatically\n")
