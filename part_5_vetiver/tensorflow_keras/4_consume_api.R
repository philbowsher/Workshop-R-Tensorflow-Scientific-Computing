# ============================================================================
# Consume Vetiver API - Keras Version
# ============================================================================
...
#   Sys.setenv(VETIVER_ENDPOINT = "content/abc-123")  # Get from Connect UI
# ============================================================================
...
cat("=======================================================================\n")
cat("CONSUMING VETIVER API - KERAS VERSION\n")
cat("=======================================================================\n\n")
...
if (endpoint == "") {
  ...
  if (endpoint == "") {
    stop("\n*** COULD NOT AUTO-DETECT ENDPOINT ***\n\n",
         ...
         "  2. Set manually: Sys.setenv(VETIVER_ENDPOINT = 'content/abc-123')\n")
  }
}
...
# Vetiver returns raw predictions (probabilities for each class)
