# ============================================================================
# Train Peptide Binding Prediction Model with Torch
# ============================================================================
# This is the torch equivalent of part_3/immunotherapy/1_train_model.R
# Using torch R for neural network training (no Python backend needed)
#
# Model predicts binding affinity of peptides to MHC molecules:
#   - NB (Non-Binder)
#   - WB (Weak Binder)
#   - SB (Strong Binder)
# ============================================================================

# Configure Python for reticulate (needed for PepTools package)
...
cat("=======================================================================\n")
cat("PEPTIDE BINDING PREDICTION - TORCH VERSION\n")
cat("=======================================================================\n\n")
...
cat("  Input layer: 180 features (9 amino acids × 20 properties)\n")
cat("  Hidden layer 1: 180 units + ReLU + Dropout(0.4)\n")
cat("  Hidden layer 2: 90 units + ReLU + Dropout(0.3)\n")
cat("  Output layer: 3 classes (NB, WB, SB)\n")
...
for (epoch in 1:EPOCHS) {
  ...
  train_loss <- criterion(train_predictions, y_train_split + 1L) # torch uses 1-indexed
...
p3 <- ggplot(conf_df, aes(x = Predicted, y = Actual, fill = Freq)) +
  ...
  labs(title = "Confusion Matrix - Peptide Binding Prediction") +
  theme_minimal()
...
cat("\n=======================================================================\n")
cat("✓ Peptide binding model training complete!\n")
cat("  Next step: Run 2_publish_model.R to pin the model to Connect\n")
cat("=======================================================================\n")
